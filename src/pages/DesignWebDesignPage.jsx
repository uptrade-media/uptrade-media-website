...
function DesignWebDesignPage() {
  ...
  const portfolioProjects = [
    {
      ...
      description:
        'Complete website redesign that delivered a 1,084.4% traffic increase through strategic design and SEO optimization.',
    ...
    },
    {
      ...
      description:
        "Vibrant website design capturing the restaurant's unique personality with bold colors and engaging user experience.",
    ...
    },
    {
      ...
      description:
        'Luxury website showcasing riverfront community with immersive visuals and lead generation focus.',
  ...
  const designServices = [
    {
      ...
      description:
        'Unique, brand-focused designs that capture your business personality and engage your target audience.',
    ...
    },
    {
      ...
      description:
        'Strategic design elements and user experience optimization to turn visitors into customers.',
    ...
    },
    {
      ...
      description:
        'Clean, efficient code and modern development practices for optimal performance and maintainability.',
  ...
  const webDesignBenefits = [
    {
      ...
      description:
        'Your website is often the first interaction customers have with your brand. Make it count with stunning, professional design.',
      icon: <Eye className="w-8 h-8" />
    },
    {
      title: 'Enhanced User Experience',
      description:
        'Intuitive navigation, fast loading times, and responsive design create seamless experiences that keep visitors engaged.',
      icon: <Users className="w-8 h-8" />
    },
    {
      title: 'Higher Conversion Rates',
      description:
        'Strategic design and clear calls-to-action guide visitors through your sales funnel and increase conversions.',
      icon: <TrendingUp className="w-8 h-8" />
    },
    {
      title: 'Mobile-First Performance',
      description:
        'With mobile traffic dominating, responsive design ensures your site performs flawlessly on every device.',
      icon: <Smartphone className="w-8 h-8" />
    },
    {
      title: 'SEO Foundation',
      description:
        'Websites built with SEO best practices from the ground up rank higher and attract more organic traffic.',
      icon: <Search className="w-8 h-8" />
    },
    {
      title: 'Brand Credibility',
      description:
        'Professional web design builds trust and establishes your business as a credible authority in your industry.',
  ...
  const process = [
    ...
    },
    {
      ...
      description:
        'Custom designs and wireframes that align with your brand and optimize user experience.'
    },
    {
      step: '03',
      title: 'Development & Testing',
      description:
        'Clean, efficient code development with rigorous testing across devices and browsers.'
    },
    {
      step: '04',
      title: 'Launch & Optimization',
      description:
        'Seamless launch with ongoing performance monitoring and optimization for maximum results.'
    }
  ]
  ...
  const faqItems = [
    {
      ...
      answer:
        'The timeline for a custom website varies based on complexity and features, but typically ranges from 4 to 8 weeks from initial concept to launch. Simple websites can be completed in 2-3 weeks, while complex e-commerce or custom functionality sites may take 8-12 weeks.'
    },
    {
      question: 'What is the cost of professional web design in Cincinnati?',
      answer:
        'Web design costs vary based on your specific needs, features, and complexity. Our custom websites typically range from $3,000 to $15,000. We provide detailed quotes after understanding your requirements and offer flexible payment plans to fit your budget.'
    },
    {
      question: 'Do you offer e-commerce website development?',
      answer:
        'Yes, we specialize in creating robust and secure e-commerce platforms using platforms like Shopify, WooCommerce, and custom solutions. Our e-commerce sites include shopping carts, payment processing, inventory management, and conversion optimization features.'
    },
    {
      question: 'Will my website be mobile-friendly and responsive?',
      answer:
        'Absolutely. All our websites are built with a mobile-first approach, ensuring they look and function perfectly on smartphones, tablets, and desktop computers. We test across all devices and browsers to guarantee optimal performance.'
    },
    {
      question: 'Do you provide SEO optimization with web design?',
      answer:
        'Yes, every website we design includes comprehensive SEO optimization. This includes optimized page structure, meta tags, fast loading speeds, mobile responsiveness, and clean code that search engines love. We also offer ongoing SEO services.'
    },
    {
      question: 'Can you redesign my existing website?',
      answer:
        "Absolutely! We specialize in website redesigns that improve user experience, increase conversions, and modernize your online presence. We can work with your existing content or help create new content that better serves your goals."
    },
    {
      question: 'Do you provide ongoing website maintenance and support?',
      answer:
        'Yes, we offer comprehensive maintenance packages including security updates, content updates, performance monitoring, backup services, and technical support. Our maintenance plans ensure your website stays secure, fast, and up-to-date.'
    },
    {
      question: 'What platforms do you use for web design?',
      answer:
        'We work with various platforms including WordPress, Shopify, React, and custom HTML/CSS solutions. We choose the best platform based on your specific needs, budget, and long-term goals to ensure optimal performance and scalability.'
    },
    {
      question: 'Do you provide website hosting services?',
      answer:
        "While we don't provide hosting directly, we partner with reliable hosting providers and can help you choose the best hosting solution for your needs. We also assist with domain registration and DNS setup for a complete solution."
    },
    {
      question: 'How do you ensure my website loads quickly?',
      answer:
        'We implement multiple performance optimization techniques including image compression, code minification, caching strategies, CDN integration, and optimized hosting configurations. We aim for page load speeds under 3 seconds on all devices.'
    },
    {
      question: 'Can you integrate my website with social media and marketing tools?',
      answer:
        'Yes, we can integrate your website with various marketing tools including Google Analytics, Facebook Pixel, email marketing platforms, CRM systems, and social media feeds. This helps you track performance and automate your marketing efforts.'
    },
    {
      question: 'What makes Uptrade Media different from other web design companies?',
      answer:
        "We combine beautiful design with strategic marketing focus. Every website we create is optimized for conversions, SEO, and user experience. Plus, we're local to Cincinnati and provide personalized service with ongoing support and digital marketing expertise."
    }
  ]
  ...
  const uiUxDesignStructuredData = {
    ...
    description:
      'Professional UI/UX design services in Cincinnati and Northern Kentucky. User-centered design that creates exceptional digital experiences and drives conversions.',
    provider: {
      '@type': 'LocalBusiness',
      name: 'Uptrade Media',
    ...
    offers: {
      '@type': 'Offer',
      description:
        'UI/UX design services including user research, wireframing, prototyping, and conversion optimization',
      priceRange: '$$'
    }
  }
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Featured Web Design Projects</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See how our custom web design solutions have transformed businesses across different
              industries, delivering measurable results and exceptional user experiences.
            </p>
          </div>
                ...
                <Card className="h-full overflow-hidden hover:shadow-xl transition-shadow duration-300">
                  <div className="relative">
                    ...
                    <div className="absolute top-4 left-4">
                      <Badge className="bg-[#4bbf39] text-white">{project.category}</Badge>
                    </div>
                  </div>
          ...
          <div className="text-center mt-12">
            <Link to="/portfolio">
              <Button
                size="lg"
                className="bg-gradient-to-r from-[#4bbf39] to-[#39bfb0] hover:from-[#39bfb0] hover:to-[#4bbf39] text-white"
              >
                View Full Portfolio
                <ArrowRight className="ml-2 w-5 h-5" />
              </Button>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From initial concept to final launch, we provide end-to-end web design and development
              services that deliver exceptional results.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Full In-House Media Production</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Why settle for stock photos when you can have custom, professional media that tells your
              unique story? Our in-house video production and commercial photography teams create
              compelling visual content that elevates your web design.
            </p>
          </div>

          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h3 className="text-2xl font-bold mb-6">The Uptrade Media Advantage</h3>
              <p className="text-lg text-gray-600 mb-6">
                Most web design agencies rely on generic stock photos and videos. We create custom visual
                content specifically for your brand, ensuring your website stands out with authentic,
                high-quality media that resonates with your audience.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Professional commercial photography that showcases your products, services, team, and
                      facilities with stunning clarity and composition.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Cinematic video content including hero videos, product showcases, testimonials, and
                      brand stories that engage visitors and increase conversions.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Our design and media teams work together from day one, ensuring perfect integration of
                      visual content with your website&apos;s design and functionality.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8">
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <p className="text-gray-600">
                  Custom media that truly represents your brand, not generic stock content that looks like
                  everyone else&apos;s.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Professional video and photography increase user engagement, time on site, and conversion
                  rates significantly.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Stand out from competitors with unique, high-quality visual content that showcases your
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold mb-6">SEO-Optimized Web Design</h2>
              <p className="text-xl text-gray-600 mb-6">
                Beautiful design means nothing if your customers can&apos;t find you. That&apos;s why every
                website we create is built with SEO best practices from the ground up.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Clean code structure, fast loading speeds, mobile optimization, and proper schema markup
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Strategic keyword placement, optimized meta tags, and content structure that both users
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Image optimization, caching strategies, and code minification for lightning-fast page
                      speeds that improve rankings.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Why Professional Web Design Matters</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              In today&apos;s digital landscape, your website is your most important marketing asset. Here&apos;s
              how professional web design drives business growth.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Our Web Design Process</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A proven methodology that ensures every website we create delivers exceptional results and
      ...
      <section className="py-20 bg-gradient-to-r from-[#4bbf39] to-[#39bfb0] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-white/90">
            Let&apos;s create a website that not only looks amazing but drives real business results. Get
            started with a free consultation and website audit.
          </p>
