            ...
            >
              ...
              <div className="grid grid-cols-2 gap-6 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <div className="text-3xl font-bold">50+
      </div>
                  <div className="text-white/80">Websites Designed
      </div>
                
      </div>
                <div className="flex flex-col items-center">
                  <TrendingUp className="w-8 h-8 text-white/90 mb-2" />
                  <div className="text-3xl font-bold">231%
      </div>
                  <div className="text-white/80">Avg Traffic Increase
      </div>
