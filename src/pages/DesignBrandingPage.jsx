  ...
  const faqItems = [
    {
      ...
      answer:
        'Our brand identity package typically includes logo design, brand guidelines (color palette, typography, imagery style), business card design, and templates for essential marketing materials.'
    },
    {
      question: 'How long does the branding process take?',
      answer:
        'The branding process usually takes between 4 to 8 weeks, depending on the scope and complexity of the project, including research, concept development, revisions, and finalization.'
    },
    {
      question: 'Can you redesign an existing logo or brand?',
      answer:
        'Yes, we offer brand refresh and redesign services. We can evolve your current brand to better reflect your business growth, new market positioning, or modern aesthetic while retaining core recognition.'
    },
    {
      question: 'Why are brand guidelines important?',
      answer:
        'Brand guidelines ensure consistency across all your communications. They provide clear rules for using your logo, colors, fonts, and messaging, helping to maintain a unified and professional brand image.'
    }
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl mb-8 text-white/90">
                ...
                growth. From logo design to comprehensive brand guidelines, we craft visual identities that
            ...
            {/* Form — standardized Card + motion pattern with submitted state */}
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
              ...
              <Card className="bg-white border-white/20 shadow-2xl">
                <CardHeader>
                  ...
                  <p className="text-gray-600">
                    Get expert insights on your brand strategy and discover how professional design can
                ...
                <CardContent className="space-y-4">
                  {submitted ? (
                    ...
                    >
                      ...
                      >
                        {isSubmitting ? 'Submitting...' : 'Get Free Brand Consultation'}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Your brand is more than just a logo; it's the entire experience your customers have with
                your business. At Uptrade Media, we specialize in creating powerful and cohesive brand
                identities that capture your essence, communicate your values, and leave a lasting
                impression.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                From initial concept and logo design to comprehensive brand guidelines and application across
                all touchpoints, we ensure your brand speaks volumes and stands out in a competitive
                marketplace. Let us help you build a brand that truly connects.
              </p>
              <Link to="/insights/brand-design-conversion-rates">
            ...
            <div>
              <div className="bg-white rounded-lg shadow-xl p-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-6 items-center">
                  ...
                  <div className="flex items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    <img
                      src="/Client_logos/Blue_Cattys_Bar_and_Grille_Logo.svg"
                ...
                <p className="text-center text-gray-600 mt-6 text-sm">
                  From restaurants to real estate, law firms to luxury developments - we create brands that
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              From initial concept to complete brand implementation, we provide everything you need to
              establish a powerful brand presence.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-6 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="text-gray-600 p-0">
                Custom logo design that captures your brand essence and works across all applications, from
            ...
            <Card className="p-6 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="text-gray-600 p-0">
                Comprehensive style guides covering logo usage, color palettes, typography, and brand voice to
                ensure consistency.
              </CardContent>
            </Card>
            ...
            <Card className="p-6 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="text-gray-600 p-0">
                Professional business card design that makes a memorable first impression and reinforces your
                brand identity.
              </CardContent>
            </Card>
            ...
            <Card className="p-6 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="text-gray-600 p-0">
                Strategic brand positioning and messaging that differentiates you from competitors and
            ...
            <Card className="p-6 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="text-gray-600 p-0">
                Modernize and evolve your existing brand to better reflect your growth and changing market
                position.
              </CardContent>
            </Card>
            ...
            <Card className="p-6 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent className="text-gray-600 p-0">
                Branded marketing collateral including brochures, flyers, presentations, and digital assets
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A strategic, collaborative journey from initial discovery to a compelling brand presence that
          ...
          <div className="grid lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                We dive deep into your business, industry, competitors, and target audience to understand what
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Based on our research, we develop a comprehensive brand strategy and create initial design
                concepts that align with your goals.
              </p>
              <ul className="text-sm text-gray-500 space-y-1">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Our designers create your logo, select colors and typography, and develop all visual elements
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                We create comprehensive brand guidelines and help you implement your new identity across all
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We understand the unique branding challenges and opportunities across different industries,
              allowing us to create targeted solutions that resonate with your specific market.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="p-6 shadow-lg">
              <CardTitle className="text-xl font-bold mb-3 text-[#4bbf39]">
                Restaurants & Food Service
              </CardTitle>
              <CardContent className="text-gray-600 p-0">
                <p className="mb-4">
                  Creating appetizing brand identities that capture the essence of your culinary experience
            ...
            <Card className="p-6 shadow-lg">
              ...
              <CardContent className="text-gray-600 p-0">
                <p className="mb-4">
                  Professional branding that builds trust and showcases properties in the best light, from
                  individual agents to major developments.
                </p>
                <ul className="text-sm space-y-1">
            ...
            <Card className="p-6 shadow-lg">
              ...
              <CardContent className="text-gray-600 p-0">
                <p className="mb-4">
                  Sophisticated branding that conveys expertise, trustworthiness, and professionalism to
            ...
            <Card className="p-6 shadow-lg">
              ...
              <CardContent className="text-gray-600 p-0">
                <p className="mb-4">
                  Compassionate and professional branding that builds patient trust and communicates care
            ...
            <Card className="p-6 shadow-lg">
              ...
              <CardContent className="text-gray-600 p-0">
                <p className="mb-4">
                  Modern, innovative branding that positions your tech company as a leader and attracts both
            ...
            <Card className="p-6 shadow-lg">
              ...
              <CardContent className="text-gray-600 p-0">
                <p className="mb-4">
                  Compelling brand identities that drive sales, build customer loyalty, and work seamlessly
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A well-crafted brand identity is the foundation of effective marketing and lasting customer
              relationships.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-[#4bbf39] to-[#39bfb0] text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Contact us today for a free consultation and discover how powerful brand identity can elevate
            your business.
          </p>
