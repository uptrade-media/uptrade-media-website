    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center">
      ...
      >
        ...
        <p className="text-xl mb-8 text-white/90">
          Dominate search results and attract more customers with proven SEO strategies. Our comprehensive approach
          combines technical optimization, content marketing, and local SEO to drive sustainable growth for your business.
        </p>

        {/* Full-width CTAs on mobile, auto on sm+ */}
        <div className="flex flex-col sm:flex-row gap-4 mb-8">
          <Link to="/free-audit" onClick={scrollToTop} className="w-full sm:w-auto">
          ...
          <a href="tel:+15133310555" className="w-full sm:w-auto">
            <Button className="w-full sm:w-auto bg-white/20 backdrop-blur-sm border border-white/30 text-white hover:bg-white/90 hover:text-[#4bbf39] px-8 py-3 transition-all duration-200 shadow-xs">
          ...
          <CardContent className="space-y-4 min-w-0">
            {submitted ? (
              <div className="text-center py-6">
                ...
                <p className="text-gray-600">
                  We have received your request and will email the audit within 24 hours.
                </p>
              </div>
            ) : (
              <form
